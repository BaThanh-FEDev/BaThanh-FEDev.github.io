$(function() {
    ...
    $(window).scroll(function(){
        ...
        if( wScroll > 400 ){
            $('[data-ht-trigger="backtop"]').addClass('is-show');
        } else {
            $('[data-ht-trigger="backtop"]').removeClass('is-show');
        }
    });
    $('[data-ht-trigger="backtop"]').click(function(){ $('html, body').animate({ 'scrollTop': 0 },500); });

    // Event c-modal
    $('body').on('click', '[data-ht-trigger="c-modal"]', function() {
